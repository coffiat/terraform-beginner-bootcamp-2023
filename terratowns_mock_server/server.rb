...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # the code and the user-uuid should be  matching for user
    # in the reails: User.dind_by access_code: code, user_uuid: user-uuid
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # begin/resource is a try/catch, if an error occurs, result it.
    begin
    ...
    # to make it easier to work with code
    name = payload["name"]
    ...
    # return the errors back to json
    unless home.valid?
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid for the Home matches the one in our database?
